...
"""Verify that starting iqcash with -h works as expected."""
import subprocess

from test_framework.test_framework import IQCashTestFramework
from test_framework.util import assert_equal

class HelpTest(IQCashTestFramework):
    ...
    def run_test(self):
        self.log.info("Start iqcash with -? for help text")
        ...
        self.log.info("Start iqcash with -version for version information")
