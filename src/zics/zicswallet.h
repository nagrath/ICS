...
#ifndef IQCASH_ZICSWALLET_H
#define IQCASH_ZICSWALLET_H
...
public:
    ...
    void GenerateDeterministicZICS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZICS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
