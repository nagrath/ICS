...
#ifndef IQCASH_ZICSTRACKER_H
#define IQCASH_ZICSTRACKER_H
...
public:
    CzICSTracker(CWallet* parent);
    ~CzICSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzICSWallet* zICSWallet = NULL);
