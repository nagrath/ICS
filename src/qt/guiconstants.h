...
/* IQCash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "IQCASH"
#define QAPP_ORG_DOMAIN "iq.cash"
#define QAPP_APP_NAME_DEFAULT "IQCASH-Qt"
#define QAPP_APP_NAME_TESTNET "IQCASH-Qt-testnet"
