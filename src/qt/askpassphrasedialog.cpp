...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            IQCASHGUI* window = static_cast<IQCASHGUI*>(parentWidget());
...
{
    IQCASHGUI* gui = static_cast<IQCASHGUI*>(parentWidget());
...
{
    hide();
    static_cast<IQCASHGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("IQCASH will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your ICSs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
