...
#include "qt/iqcash/sendcustomfeedialog.h"
#include "qt/iqcash/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(IQCASHGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &IQCASHGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
