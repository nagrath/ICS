...
#include "qt/iqcash/settings/settingsnetworkwidget.h"
#include "qt/iqcash/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/iqcash/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(IQCASHGUI* _window, QWidget *parent) :
