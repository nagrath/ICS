...
#include "qt/iqcash/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/iqcash/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(IQCASHGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the IQCASH RPC console.") + "<br>" +
