...
#include "qt/iqcash/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(IQCASHGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &IQCASHGUI::openFAQ);
