...
#include "qt/iqcash/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/iqcash/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(IQCASHGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableICS,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableICS,
    ...
    connect(ui->pushButton_UnspendableICS, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableICS);});
    ...
    if (parent)
        connect(parent, &IQCASHGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
