...
#include "qt/iqcash/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(IQCASHGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("IQCASH_tx_csv_export(*.csv)") : tr("IQCASH_addresses_csv_export(*.csv)"),
                                        nullptr);
