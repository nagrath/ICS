...
#include "qt/iqcash/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/iqcash/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(IQCASHGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to IQCASHGUI::handleRestart()
