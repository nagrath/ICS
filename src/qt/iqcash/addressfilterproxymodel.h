...
#ifndef IQCASH_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define IQCASH_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //IQCASH_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
