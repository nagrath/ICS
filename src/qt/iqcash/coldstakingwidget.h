...
#include "qt/iqcash/furabstractlistitemdelegate.h"
#include "qt/iqcash/txviewholder.h"
#include "qt/iqcash/tooltipmenu.h"
#include "qt/iqcash/sendmultirow.h"
#include "qt/iqcash/coldstakingmodel.h"
#include "qt/iqcash/contactsdropdown.h"
#include "qt/iqcash/addressholder.h"
...
public:
    explicit ColdStakingWidget(IQCASHGUI* parent);
    ~ColdStakingWidget();
