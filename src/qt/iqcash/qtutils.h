...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, IQCASHGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, IQCASHGUI* gui, double posX = 3);
