...
#include "config/iqcash-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalIcs = 0;
    qint64 totalZics = 0;
    QList<qreal> valuesIcs;
    QList<qreal> valueszIcs;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(IQCASHGUI* _window);
    ~DashboardWidget();
