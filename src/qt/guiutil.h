...
/** Utility functions used by the IQCASH Qt UI.
 */
namespace GUIUtil
{
...
// Render IQCASH addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZics = false);
...
// Parse "iqcash:" URI into recipient object, return true on successful parsing
