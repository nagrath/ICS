...
#ifndef IQCASH_STAKEINPUT_H
#define IQCASH_STAKEINPUT_H
...
public:
    ...
    bool IsZICS() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //IQCASH_STAKEINPUT_H
