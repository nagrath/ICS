...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("IQCash Core iqcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  iqcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded iqcash transaction") + "\n" +
                               "  iqcash-tx [options] -create [commands]   " + _("Create hex-encoded iqcash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded iqcash transaction
