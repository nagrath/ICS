...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (2365700, uint256S("b5d0beead57735539abc2db2b0b08cd65db3e5928efd3c3bf3182d5bf013f36c")); //!< IQCASH v4.1.1 enforced
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    ...
    (1608352, uint256S("34a1ae222b2794f34b13e87b34c6ab1b0849c80c372ca0070ceab77a83534f15")); //!< IQCASH v4.1.1 enforced
...
public:
    CMainParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // IQCASH starting difficulty is 1 / 2^12
        ...
        // validation by-pass
        consensus.nIQCashBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nIQCashBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "iqcash.seed.fuzzbawls.pw", true));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "iqcash.seed2.fuzzbawls.pw", true));    // Secondary DNS Seeder from Fuzzbawls
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "icsks";
...
public:
    CTestNetParams()
    {
        ...
        // validation by-pass
        consensus.nIQCashBadBlockTime = 1489001494; // Skip nBit validation of Block 201 per PR #915
        consensus.nIQCashBadBlockBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "iqcash-testnet.seed.fuzzbawls.pw", true));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "iqcash-testnet.seed2.fuzzbawls.pw", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet iqcash addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet iqcash script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet iqcash BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet iqcash BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet iqcash BIP44 coin type is '1' (All coin's testnet default)
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "icsktestsapling";
