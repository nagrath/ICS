...
extern UniValue setzicsseed(const JSONRPCRequest& request);
extern UniValue getzicsseed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzics(const JSONRPCRequest& request);
extern UniValue dzicsstate(const JSONRPCRequest& request);
