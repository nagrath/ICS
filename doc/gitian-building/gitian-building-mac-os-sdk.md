...
The script [extract-osx-sdk.sh](https://github.com/IQCASH/IQCash/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
iqcash/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/IQCASH/IQCash/blob/master/doc/README_osx.md) for troubleshooting tips.