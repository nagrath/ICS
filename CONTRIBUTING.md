Contributing to IQCASH Core
============================

The IQCASH Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/IQCASH/IQCash/blob/master/doc/translation_process.md)
...
The following applies to code changes to the IQCASH Core project, and is not to be
confused with overall IQCASH Network Protocol consensus changes.

Whether a pull request is merged into IQCASH Core rests with the project merge
...
Patches that change IQCASH consensus rules are considerably more involved than
...
Where a patchset proposes to change the IQCASH consensus, it must have been
...
The project leader is the release manager for each IQCASH Core release.
