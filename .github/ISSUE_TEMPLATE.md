...
This issue tracker is only for technical issues related to IQCASH Core.
General IQCASH questions and/or support requests and are best directed to the [IQCash Discord](https://discord.gg/Ruc4K4V).
...
### What version of IQCASH Core are you using?
